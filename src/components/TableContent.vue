<template>
  <div>
    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="country in countries.data" v-bind:key="country.id">
          <td
            v-for="(element, index) in country.attributes"
            v-bind:key="element._id"
          >
            <router-link
              v-if="index == 'name' && isCountry == true"
              @click="$emit('newID', country.id)"
              :to="{ path: '/' + country.id }"
              >{{ element }}</router-link
            >
            <p v-else>{{ element }}</p>
          ...
          <td v-if="isCountry">
            <button class="del-edit" @click="onEditClickCountry(country.id)">
          ...
          <td v-else>
            <button
              class="del-edit"
              @click="
                onEditClick(country.id, country.relationships.country.data.id)
              "
            >
              <img src="../assets/edit.png" alt="Edit" />
            </button>
          ...
          <td v-if="isCountry">
            <button class="del-edit" @click="deleteCountry(country.id)">
          ...
          <td v-else>
            <button
              class="del-edit"
              @click="
                deleteCity(country.id, country.relationships.country.data.id)
              "
            >
              <img src="../assets/trash.png" alt="Delete" />
            </button>
    ...
    <modal
      :editableCountryID="editableCountryID"
      :editableCityID="editableCityID"
      :isCountry="isCountry"
      @edited="onEdited"
      @close="editCountry = false"
      v-show="editCountry"
    ></modal>
  </div>
</template>
